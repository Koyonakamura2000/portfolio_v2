...
function NightReflection() {
    ...
    return (
        <>
            ...
            <ProjectColumn heading='Impact' text='My research expands on the field of reflection design by detailing specific aspects to consider when designing a reflection-related intervention for the night-time context. I submitted my research to the SIGDOC Student Research Competition and it was accepted for publication at the 2021 SIGDOC conference!' link='https://dl.acm.org/doi/10.1145/3472714.3475820'></ProjectColumn>
        </>
    );
}
