...
function NightReflection() {
    ...
    return (
        <>
            <ProjectIntro image={reflectionWide} duration='March 2021 - October 2021' name='Designing for Night-Time Reflection' 
            ...
            <ResearchQuestion color='black' text='How can I help people engage in and act upon their night-time reflection?'></ResearchQuestion>
            ...
            <ProjectColumn heading='User Research' text='With the help of my teammates, I conducted semi-structured interviews and distributed an online survey to answer these questions. *Names and photos are anonymized'></ProjectColumn>
            <Participants>
            ...
            <ProjectColumn heading='Survey' text='I designed a survey on Google Forms and distributed it mainly through the University of Washington subreddit, asking questions pertaining to how the wider population experiences night-time reflection.'></ProjectColumn>
