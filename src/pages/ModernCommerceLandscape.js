import mclMockupVeryWide from '../assets/images/home/commercetools_mockup_verywide.jpg';
...
function ModernCommerceLandscape() {
    ...
    return (
        <>
            ...
            <ResearchQuestion id='researchQuestion' color='#3f788b' text='How can I design a website that helps technical and non-technical people explore the modern e-commerce landscape?'></ResearchQuestion>
            <ProjectColumn id='competitiveAnalysis' heading='Competitive Analysis' text='I first researched other websites that provide a comparison of services. I found that most websites display the information in one table, which was sometimes overbearing.'
            ...
            <ProjectColumn id='initialPrototype' heading='Initial Prototype' text='Based on analyzing existing platforms and initial discussions with my manager, I designed a prototype that aims to reduce information overload and technical jargon.'
            image={v1Prototype} caption='Instead of displaying all of the services at once, the user is first prompted to select from a list of general categories.' link={['https://www.figma.com/file/G8m1HFkXVcqssubHqGAZcO/commercetools?node-id=10%3A0', 'View on Figma']}></ProjectColumn>
            <ProjectColumn id='usabilityTesting' heading='Usability Testing' text='Participants found that the category names were too confusing (jargon) and some UI elements were unintuitive, preventing them from being able to complete their task.'
            ...
            <ProjectColumn id='secondPrototype' heading='Second Prototype' text='I implemented the following changes to the prototype based on the feedback:' 
            ...
            'Keeping calls to action consistent across the whole user experience']} link={['https://www.figma.com/file/G8m1HFkXVcqssubHqGAZcO/commercetools?node-id=52%3A237', "View on Figma"]}></ProjectColumn>
            ...
            <ProjectColumn id='implementation' heading='Implementation' text='I implemented the website in plain HTML/CSS/JavaScript and deployed to Google App Engine. Separating data structures in data.js facilitates developer changes, which is essential for the constantly updating e-commerce landscape.'
            image={implementation}></ProjectColumn>
            <ProjectColumn id='impact' heading='Impact' text='I received positive feedback from commercetools, who appreciated the "demystifying" of technical language and intuitive user flow. Website visitors found the tool useful as a way to "stay in the know" of e-commerce trends and 
            some companies have reached out to be included in the website.'></ProjectColumn>
            <ProjectColumn id='reflection' heading='Reflection' text='If I was to revise or continue this project, I would:' 
